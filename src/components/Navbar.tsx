            ...
            {user && (
              <div className="relative hidden md:block">
                <button
                  ...
                  className="flex items-center space-x-2 rounded-md bg-gray-50 px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2"
                >
                    ...
                    <div className="absolute right-0 z-20 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <div className="py-1">
                        <div className="px-4 py-2 text-sm text-gray-700 border-b border-gray-200">
                          ...
                          <div className="text-xs text-gray-500">Society: {user.societyCode}</div>
                        </div>
                        <button
                          onClick={() => {
                            closeProfileDropdown();
